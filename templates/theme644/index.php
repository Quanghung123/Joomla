					...
					<div class="row-container">
						<div class="<?php echo $containerClass; ?>">
							<div class="<?php echo $rowClass; ?>">
								...
								<?php echo $todesktop; ?>
								More <a rel="nofollow" href="http://www.templatemonster.com/category/watches-virtuemart-templates/" target="_blank">Watches VirtueMart Templates at TemplateMonster.com</a>
							</div>
						</div>
					</div>
				</div>
